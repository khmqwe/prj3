...
public class InfoTourModifyVO {
	...
	public InfoTourModifyVO() {
	}
	public InfoTourModifyVO(int to_num, String to_name, String to_take_time, int la_num, String thumb_img,
			String plan_explain, String to_meeting_time, String to_meeting_loc, String to_start_date,
			String to_end_date, int tr_num, int to_price) {
		this.to_num = to_num;
