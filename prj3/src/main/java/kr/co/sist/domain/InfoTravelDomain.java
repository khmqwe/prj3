...
public class InfoTravelDomain {
	...
	public InfoTravelDomain() {
	
	}
	
	public InfoTravelDomain(String tr_name, int a_num, String thumb_img, String img1, String img2, String img3,
